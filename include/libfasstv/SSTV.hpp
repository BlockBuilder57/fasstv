	...
	class SSTV {
	   public:
		...
		struct Mode {
			...
			std::uint16_t instruction_loop_start;
			std::uint16_t instruction_loop_num_lines;
		};
		...
		std::vector<Mode> MODES = {
			// Robot
			{ "Robot 12", 0, ScanType::YRYBY, 160, 120,
				...
				ROBOT_4_2_0_INSTRUCTIONS, 0, 2
			},
			{ "Robot 24", 4, ScanType::YRYBY, 160, 120,
				{9.0f, 3.0f, 88.0f, 4.5f, 1.5f, 44.0f}, // sync pulse, sync porch, Y scan, separator pulse, porch, R-Y/B-Y scan
				{1200, 1500, 1900, 2300}, // sync pulse, sync porch/even separator pulse, porch, odd separator pulse
				ROBOT_4_2_2_INSTRUCTIONS, 0, 1
			},
			{ "Robot 36", 8, ScanType::YRYBY, 320, 240,
				{9.0f, 3.0f, 88.0f, 4.5f, 1.5f, 44.0f}, // sync pulse, sync porch, Y scan, separator pulse, porch, R-Y/B-Y scan
				{1200, 1500, 1900, 2300}, // sync pulse, sync porch/even separator pulse, porch, odd separator pulse
				ROBOT_4_2_0_INSTRUCTIONS, 0, 2
			},
			{ "Robot 72", 12, ScanType::YRYBY, 320, 240,
				{9.0f, 3.0f, 138.0f, 4.5f, 1.5f, 69.0f}, // sync pulse, sync porch, Y scan, separator pulse, porch, R-Y/B-Y scan
				{1200, 1500, 1900, 2300}, // sync pulse, sync porch/even separator pulse, porch, odd separator pulse
				ROBOT_4_2_2_INSTRUCTIONS, 0, 1
			},
			{ "B&W 8", 2, ScanType::Monochrome, 160, 120,
				{10.0f, 56.0f}, // sync, scan
				{1200}, // sync
				ROBOT_MONOCHROME_INSTRUCTIONS, 0, 1
			},
			{ "B&W 12", 6, ScanType::Monochrome, 160, 120,
				{7.0f, 93.0f}, // sync, scan
				{1200}, // sync
				ROBOT_MONOCHROME_INSTRUCTIONS, 0, 1
			},
			{ "B&W 24", 10, ScanType::Monochrome, 320, 240,
				{12.0f, 93.0f}, // sync, scan
				{1200}, // sync
				ROBOT_MONOCHROME_INSTRUCTIONS, 0, 1
			},
			{ "B&W 36", 14, ScanType::Monochrome, 320, 240,
			...
			// Martin
			{ "Martin 1", 44, ScanType::RGB, 320, 256,
				{4.862f, 0.572f, 146.432f}, // pulse, porch, color scan
				{1200, 1500}, // pulse, porch
				MARTIN_INSTRUCTIONS, 0, 1
			},
			{ "Martin 2", 40, ScanType::RGB, 320, 256,
				{4.862f, 0.572f, 73.216f}, // pulse, porch, color scan
				{1200, 1500}, // sync pulse, porch
				MARTIN_INSTRUCTIONS, 0, 1
			},
			{ "Martin 3", 36, ScanType::RGB, 128, 256,
				{4.862f, 0.572f, 146.432f}, // pulse, porch, color scan
				{1200, 1500}, // pulse, porch
				MARTIN_INSTRUCTIONS, 0, 1
			},
			{ "Martin 4", 32, ScanType::RGB, 128, 256,
				{4.862f, 0.572f, 73.216f}, // pulse, porch, color scan
				{1200, 1500}, // sync pulse, porch
				MARTIN_INSTRUCTIONS, 0, 1
			},
			...
			// Wraase
			{ "Wraase SC2-180", 55, ScanType::RGB, 320, 256,
				{5.5225f, 0.500f, 235.000f}, // pulse, porch, color scan
				{1200, 1500}, // sync pulse, porch
				WRASSE_INSTRUCTIONS, 0, 1
			},

			// Scottie
			{ "Scottie 1", 60, ScanType::RGB, 320, 256,
				{9.0f, 1.5f, 138.240f}, // sync pulse, separator pulse
				{1200, 1500}, // sync pulse, separator pulse
				SCOTTIE_INSTRUCTIONS, 1, 1
			},
			{ "Scottie 2", 56, ScanType::RGB, 320, 256,
				{9.0f, 1.5f, 88.064f}, // sync pulse, separator pulse
				{1200, 1500}, // sync pulse, separator pulse
				SCOTTIE_INSTRUCTIONS, 1, 1
			},
			{ "Scottie DX", 76, ScanType::RGB, 320, 256,
			...
			// Pasokon
			{ "Pasokon P3", 113, ScanType::RGB, 640, 496,
				{5.208f, 1.042f, 133.333f}, // pulse, porch, color scan
				{1200, 1500}, // pulse, porch
				PASOKON_INSTRUCTIONS, 0, 1
			},
			{ "Pasokon P5", 114, ScanType::RGB, 640, 496,
				{7.813f, 1.563f, 200.000f}, // pulse, porch, color scan
				{1200, 1500}, // pulse, porch
				PASOKON_INSTRUCTIONS, 0, 1
			},
			{ "Pasokon P7", 115, ScanType::RGB, 640, 496,
			...
			// Custom Things
			{ "Block57", 57, ScanType::RGB, 1280, 720,
				{4.f, 3.0f, 81.f}, // pulse, porch, color scan
				{1200, 1500}, // sync pulse, porch
				BLOCK_INSTRUCTIONS, 0, 1
			},

			{ "Robot 57", 58, ScanType::YRYBY, 1280/4, 720/4,
				{9.0f, 3.0f, 88.0f, 4.5f, 1.5f, 44.0f}, // sync pulse, sync porch, Y/A scan, separator pulse, porch, R-Y/B-Y scan
				{1200, 1500, 1900, 2300}, // sync pulse, sync porch/even separator pulse, porch, odd separator pulse
				BLOCK_ROBOT_INSTRUCTIONS, 0, 1
			},
		};
		...
		static void CreateInstructions(std::vector<Instruction>& instructions, const Mode* mode, bool clear = true, bool with_extras = true);
